...
تقویم فارسی اندروید
این برنامه به صورت شخصی، مستقل، رایگان و متن‌باز نوشته شده‌است و کد آن را می‌توانید از https://github.com/persian-calendar/DroidPersianCalendar دریافت کنید.
 که ما این سورس را شخصی سازی نموده ایم
